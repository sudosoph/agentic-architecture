...
For agentic verification on top, **Pydantic AI** ([pydantic.ai](https://pydantic.ai)) plus a small validator-only model handles the schema-and-plausibility loop without sending documents to a frontier model.
