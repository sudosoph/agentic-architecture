...
The observability discipline this requires is what Charity Majors at Honeycomb calls [Observability 2.0](https://charity.wtf/tag/observability-2-0/): arbitrarily-wide structured events, not the old three-pillars split. For agentic systems specifically, the [feedback loop pattern](https://www.honeycomb.io/blog/observability-age-of-ai) (Prompt → Deploy → Observe → Analyze → Optimize → Redeploy) is the production version of what self-healing pipelines automate.
