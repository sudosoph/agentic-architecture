...
3. **Semantic.** Query the knowledge graph for facts related to those events ("the team uses Postgres with pgvector," "the bug class is connection-pool exhaustion").
